 ...
 *     description: Retrieve list of unique product categories
 *     responses:
 *       200:
 ...
 *     description: Delete a product (sellers can only delete their own products)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     description: Add a review and rating for a product (authenticated users only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *   get:
 *     tags: [Products]
 *     summary: Get seller's products (Seller/Admin only)
 ...
 *   get:
 *     tags: [Products]
 *     summary: Get seller product statistics (Seller/Admin only)
 *     description: Get statistics for seller's products
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 ...
 *   put:
 *     tags: [Products]
 *     summary: Admin update product (Admin only)
 *     description: Update any product with admin privileges
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *   delete:
 *     tags: [Products]
 *     summary: Admin delete product (Admin only)
 *     description: Delete any product with admin privileges
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
