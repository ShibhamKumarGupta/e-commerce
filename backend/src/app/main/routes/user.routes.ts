 ...
 *     description: Get overview statistics for users
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 *
 * /users/analytics/monthly-growth:
 *   get:
 *     tags: [Users]
 *     summary: Get monthly user growth analytics (Admin only)
 *     description: Get user registration growth by month
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
